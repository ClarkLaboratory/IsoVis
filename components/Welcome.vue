...
<b-container>
    ...
    <b-modal v-model="modal.clarkLabData.show" size="xl" title="Download demo or Clark Lab data" hide-footer>
        ...
        <b-button variant="primary" @click="downloadFile('Gleeson_et_al_SciAdv_2025.zip')">.zip (7.85 MB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
        <b-button variant="primary" @click="downloadFile('Gleeson_et_al_SciAdv_2025.7z')">.7z (6.09 MB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
        <b-button variant="primary" @click="downloadFile('Gleeson_et_al_SciAdv_2025.tar.gz')">.tar.gz (7.84 MB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
        <b-button variant="primary" @click="downloadFile('Gleeson_et_al_SciAdv_2025.tar.xz')">.tar.xz (6.09 MB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
        ...
        <b-button variant="primary" @click="downloadFile('DePaoliIseppi_et_al_GenomeBiol_2025.zip')">.zip (122 kB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
        <b-button variant="primary" @click="downloadFile('DePaoliIseppi_et_al_GenomeBiol_2025.7z')">.7z (111 kB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
        <b-button variant="primary" @click="downloadFile('DePaoliIseppi_et_al_GenomeBiol_2025.tar.gz')">.tar.gz (120 kB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
        <b-button variant="primary" @click="downloadFile('DePaoliIseppi_et_al_GenomeBiol_2025.tar.xz')">.tar.xz (111 kB) <b-icon-download aria-hidden="true"></b-icon-download></b-button>
