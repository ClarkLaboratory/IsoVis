...
<template>
<div id="canonDiv" class="req-crosshair" ref="parentDiv" style="position: relative">
...
export default {
    ...
    methods: {
        ...
        buildStack() {
            ...
            // // Append SVG
            // let svg = d3.select('#canonDiv').append("svg")
            //     .attr('id', 'canonstack-svg')
            ...
            //     .data(self.canonData.isoformList, function (d) {return d.transcriptID;})
            //     .enter()
            // .append("g")
            //     .attr("class", "isoform")
