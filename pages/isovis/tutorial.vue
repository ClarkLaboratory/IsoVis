    ...
    <b-container class="text-justify">
        ...
        <div>
            ...
            <ol>
                ...
                <li><b-link href="#uploading_additional_data">Uploading and visualizing additional data types</b-link></li>
                <ul>
        ...
        <div>
            ...
            <br><br>
            The 'Canonical isoform' is the Ensembl canonical isoform associated with the gene being visualized. <b-link href="https://www.ensembl.org/info/genome/genebuild/canonical.html?redirect=no" target="_blank">According to Ensembl</b-link>, the canonical isoform is defined as 'a single, representative transcript identified at every locus', and for genes encoding proteins, is the transcript that, 'on balance, has the highest coverage of conserved exons, highest expression, longest coding sequence and is represented in other key resources, such as NCBI and UniProt'.
        </div>
        <br>
        <div class="text-center">
        ...
        <div>
            ...
            <br><br>
            Some components contain gear icons (<b-icon-gear-fill></b-icon-gear-fill>). These are dropdown menus containing options specific to the component they are placed in. For example, the protein diagram has options for toggling the mapping for protein domains and motifs, as well as labels for the protein domains (beta).
        </div>
        <br>
        <div class="text-center">
        ...
        <br>
        <div>
            Users can zoom into specific genomic coordinates either by entering them in the 'Zoom to coordinates' text box at the top of the page and pressing enter or clicking the '>' button that appears next to the box. Alternatively, the user can click, drag, and release the cursor at the desired genomic coordinates in the stack. To reset the zooming, click on the 'Reset zoom' button at the top of the page.
            <br><br>
        ...
        <div>
            ...
            <br><br>
            If the uploaded isoform stack file contains data on more than one gene, the user is prompted by a pop-up to select a gene to visualize. To do so, users can click on the search box to pick from a list of the first 100 genes found in the uploaded isoform stack data. To find a specific gene, start typing either its symbol or ID in the search box, then select from a list of possible genes to visualize. Finally, press enter or click on the '>' button next to the search box.
            <br><br>
        ...
        <br>
        <b-link name="uploading_additional_data"></b-link>
        <h3>Uploading and visualizing additional data types</h3>
        <br>
        <div>
            Apart from isoform stack data and heatmap data, IsoVis can also visualize <b-link href="#rna_modifications_data">RNA modifications data</b-link> and <b-link href="#peptide_data">peptide data</b-link>.
        </div>
        <br>
        <b-link name="rna_modifications_data"></b-link>
        <b><u>RNA modifications data:</u></b>
        <br><br>
        <div>
            Click on the 'Upload data' button, then tick the checkbox for 'Show RNA modifications data upload options (beta)'. The 'Upload data' popup will now show two additional buttons, one for uploading a BED file of RNA modification site locations and the other for uploading RNA modification levels heatmap data.
        </div>
        <br>
        <div class="text-center">
            <b-img src="~/assets/tutorial/upload_data_rna_modif.png" style="max-width: 45vw;"></b-img>
            <br>
            Uploading RNA modifications data files in the 'Upload data' popup. The four files shown in this image can be downloaded from the data associated with 'Gleeson J et al. Isoform-level profiling...' in the 'Download demo or Clark Lab data' menu at the IsoVis home page.
        </div>
        <br>
        <div>
            After selecting a gene to visualize, the user will now see RNA modification sites displayed as a single row (compact mode) in the stack.
            <br><br>
            In compact mode, the RNA modification levels heatmap is hidden. To show the heatmap and draw RNA modification sites in separate rows, click on the <b-icon-arrows-expand></b-icon-arrows-expand> icon next to the 'RNA modification sites (beta):' label to disable compact mode.
        </div>
        <br>
        <div class="text-center">
            <b-img src="~/assets/tutorial/rna_modif_visualization_example.png" style="max-width: 55vw;"></b-img>
            <br>
            Example visualized RNA modifications data in IsoVis (compact mode disabled). The data from 'Gleeson J et al. Isoform-level profiling...' in the 'Download demo or Clark Lab data' menu is shown, with some RNA modification sites hidden.
        </div>
        <br>
        <div>
            Similar to the user isoforms, RNA modification sites can also be sorted. In the screenshot above, the first four icons next to the 'RNA modification sites (beta):' label are for sorting the sites by ascending / descending genomic coordinates, and by ascending / descending mean RNA modification levels. The fifth and last icon (<b-icon-arrows-collapse></b-icon-arrows-collapse>) enables compact mode, which hides the RNA modification levels heatmap and draws all RNA modification sites in one row.
        </div>
        <br>
        <b-link name="peptide_data"></b-link>
        <b><u>Peptide data:</u></b>
        <br><br>
        <div>
            Click on the 'Upload data' button, then tick the checkbox for 'Show peptide data upload options (beta)'. The 'Upload data' popup will now show two additional buttons, one for uploading a peptide BED file and the other for uploading peptide counts heatmap data.
        </div>
        <br>
        <div class="text-center">
            <b-img src="~/assets/tutorial/upload_data_peptide.png" style="max-width: 45vw;"></b-img>
            <br>
            Uploading peptide data files in the 'Upload data' popup. They are based on the example peptide data shown in <b-link href="../help_upload/" target="_blank">the 'Help on upload data' page</b-link>.
        </div>
        <br>
        <div>
            After selecting a gene to visualize, the user will now see peptides displayed as a single row (compact mode) in the stack.
            <br><br>
            In compact mode, the peptide counts heatmap is hidden. To show the heatmap and draw peptides in separate rows, click on the <b-icon-arrows-expand></b-icon-arrows-expand> icon next to the 'Peptides (beta):' label to disable compact mode.
        </div>
        <br>
        <div class="text-center">
            <b-img src="~/assets/tutorial/peptide_visualization_example.png" style="max-width: 55vw;"></b-img>
            <br>
            Example visualized peptide data in IsoVis (compact mode disabled).
        </div>
        <br>
        <div>
            Similar to the user isoforms, peptides can also be sorted. In the screenshot above, the first four icons next to the 'Peptides (beta):' label are for sorting the peptides by ascending / descending amino acid sequences, and by ascending / descending mean peptide counts. The fifth and last icon (<b-icon-arrows-collapse></b-icon-arrows-collapse>) enables compact mode, which hides the peptide counts heatmap and draws all peptides in one row.
        </div>
    </b-container>
</template>
...
import { BContainer, BIconArrowsCollapse, BIconArrowsExpand, BIconGearFill, BImg, BLink } from 'bootstrap-vue';
